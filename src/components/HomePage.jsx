    ...
    return(
        <div className="HomePage">
            ...
            <div className="privacy" onClick={() => setShowPrivacy(false)}>
                ...
                <li>
                <p><strong>Application</strong> refers to Expense Tracker, the software program provided by the Company.</p>
                </li>
                <li>
                ...
                <ul>
                <li>By visiting this page on our website: <a href="https://github.com/Kevin-Wei-KW/expense-tracker" rel="external nofollow noopener" target="_blank">https://github.com/Kevin-Wei-KW/expense-tracker</a></li>
                </ul>
